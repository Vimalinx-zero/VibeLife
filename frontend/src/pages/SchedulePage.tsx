...
const SchedulePage: React.FC = () => {
  ...
  const [events, setEvents] = useState<CalendarEvent[]>([
    { id: '1', date: 5, month: 2, year: 2026, type: 'meeting', title: '项目会议', description: '讨论 ResoMate 开发进度' },
    { id: '2', date: 12, month: 2, year: 2026, type: 'deadline', title: 'FlowStudy 提交', description: '完成学习报告' },
    { id: '3', date: 18, month: 2, year: 2026, type: 'reminder', title: '代码审查', description: '审查 Wilson 的代码' },
    { id: '4', date: 25, month: 2, year: 2026, type: 'task', title: '部署上线', description: '部署 VibeLife 到生产环境' },
  ]);
            ...
            <div className="mb-6 p-4 rounded-lg border border-gray-200 dark:border-gray-700 bg-white/70 dark:bg-black/20">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2">
                  <select
                    value={newEventType}
                    onChange={(event) => setNewEventType(event.target.value as CalendarEvent['type'])}
                    disabled={!selectedDate}
